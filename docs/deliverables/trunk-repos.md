...
- The component for the package. For each project, a component is defined in [rdoinfo openstack packages file](https://github.com/redhat-openstack/rdoinfo/blob/master/rdo.yml). For neutron the component is `network` (you can find it easily with [`rdopkg info`](../contribute/intro-packaging.md#rdopkg) tool).
...
<img src="../../assets/RDO Trunk repositories shema.png" width="100%" class="center">
