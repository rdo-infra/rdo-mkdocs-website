...
* Go to [RDO mailing list](../community/mailing-lists.md)
...
* Feel free to check out the [IRC etiquette](../community/irc-etiquette.md)
  guide.
...
[rdopkg](./intro-packaging.md/#rdopkg), and
...
* Feel free to familiarize yourself with [RDO Packaging](packager.md) documentation.
* Clone the project.
