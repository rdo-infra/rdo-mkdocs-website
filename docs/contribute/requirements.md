...
- [RDO CloudSIG repositories](../deliverables/repos.md#rdo-cloudsig-repositories). When a package is not available from previous repos, it will
...
the CloudSIG using [rdopkg](../contribute/intro-packaging.md#rdopkg):
